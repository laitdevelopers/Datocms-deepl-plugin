    ...
    const SidebarPanel = () => {
      ...
      const handleTranslate = async () => {
        ...
        try {
          ...
          apiUrl.searchParams.set("url", `https://api.deepl.com/v2/translate`); // Actual DeepL API endpoint
        ...
        <Canvas ctx={ctx}>
              ...
              renderTrigger={({ open, onClick }) => (
                ...
                >
                  {availableSourceLanguages.find(
                    (lang) =>
                      lang.code === sourceLanguage.split("-")[0].toUpperCase(),
                  )?.name ?? "ERROR"}
                </Button>
              )}
            >
          ...
          >
            ...
            {availableSourceLanguages
              .find(
                (lang) => lang.code === ctx.locale.split("-")[0].toUpperCase(),
              )
              ?.name.toLowerCase()}
          </Button>
